...
export const appRoutes: Routes = [
  ...
  {
    path: 'restaurants',
    loadComponent: () => import('./component/restaurant-list/restaurant-list.component').then(m => m.RestaurantListComponent)
  },
  {
    path: 'menu',
  ...
  {
    path: 'track',
    loadComponent: () => import('./component/order-tracking/order-tracking.component').then(m => m.OrderTrackingComponent)
  },
  {
    path: 'user',
  ...
  {
    path: '',
    redirectTo: '/restaurants', pathMatch: 'full'
  },
  { path: '**', redirectTo: '' }
];
